...
def main() -> None:
    ...
    parser.add_argument("--modes", default="solve")
    ...
    parser.add_argument("--csv-path", default="results/linear_mpc/throughput_mpc_boxosqp.csv")
    parser.add_argument("--plot-path", default="results/linear_mpc/throughput_mpc_boxosqp.png")
    parser.add_argument("--horizon-sweep", default="5,10,20,40")
    parser.add_argument("--horizon-batch-sizes", default="512,2048,10000,20000")
    parser.add_argument("--horizon-csv-path", default="results/linear_mpc/horizon_sweep_mpc_boxosqp.csv")
    parser.add_argument("--horizon-plot-path", default="results/linear_mpc/horizon_sweep_mpc_boxosqp.png")
