...
def main() -> None:
    ...
    parser.add_argument("--csv-path", default="results/linear_mpc/throughput_mpc_qpax.csv")
    parser.add_argument("--plot-path", default="results/linear_mpc/throughput_mpc_qpax.png")
