...
export CRAZYFLIE_BATCH_SIZES="${CRAZYFLIE_BATCH_SIZES:-${MPAX_CRAZYFLIE_BATCH_SIZES:-512,2048,10000,20000,50000,100000,200000,300000}}"
export CRAZYFLIE_OUTPUT_NAME="${CRAZYFLIE_OUTPUT_NAME:-crazyflie_sqp_rollout_mpax}"
export MAX_ITER="${MAX_ITER:-25}"

exec "${SCRIPT_DIR}/run_crazyflie_sqp_rollout.sh" "$@"
